...
const PaymentPendingView: React.FC<PaymentPendingViewProps> = ({
    booking,
    paymentMethod,
    formatPrice,
}) => {
                ...
                <div className="lg:w-2/3">
                    ...
                    <div className="flex flex-col items-center justify-center p-6 printable-section">
                        <div className="text-center">
                            {/* Pending Icon and Title */}
                            <Icon icon="token-branded:wait" className="w-24 h-24 mx-auto mb-1 text-yellow-500" />
