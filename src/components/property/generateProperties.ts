...
const titles = ["Apartments De Grande", "The Central Park Hotel", "Water Front Classic", "The Yellow Base", "Hotel De Luna", "Park Luddison Hotel", "Red Edigurgh", "The White House", "Peaceful Stay", "The Aparte Lodge"];
