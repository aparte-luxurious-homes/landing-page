...
import { AparteFormData } from '../ListApartePage';
...
const ListFlow8: React.FC<ListFlow8Props> = ({ onNext, setFormData }) => {
  ...
  const handleSubmission = async () => {
    ...
    try {
      ...
      // Update form data with featured unit if this unit is featured
      if (newUnit.is_featured) {
        setFormData(prev => ({
          ...prev,
          featuredUnit: {
            name: newUnit.title.trim(),
    ...
    if (units.uploaded.length > 0) {
      ...
      setFormData(prev => ({
        ...
        selectedUnit: {
          ...
          price_per_night: firstUnit.price_per_night,
          max_guests: firstUnit.max_guests,
          count: firstUnit.count,
          is_whole_property: firstUnit.is_whole_property,
          bedroom_count: firstUnit.bedroom_count,
          bathroom_count: firstUnit.bathroom_count,
          living_room_count: firstUnit.living_room_count,
          kitchen_count: firstUnit.kitchen_count,
